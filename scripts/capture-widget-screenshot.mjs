...
try {
  ...
  await page.route('https://store.steampowered.com/app/3375780/Trails_in_the_Sky_1st_Chapter/', (route) => route.fulfill({
    ...
    body: `<!doctype html><html><head><style>
      ...
      .page{display:grid;grid-template-columns:1fr 360px;gap:24px;max-width:1120px;margin:auto}.hero{height:440px;border-radius:8px;background:linear-gradient(135deg,#334b63,#182534);box-shadow:0 10px 40px #0008}.apphub_AppName{max-width:1120px;margin:0 auto 18px;font-size:28px}.rightcol{width:360px}
    </style><meta property="og:title" content="Trails in the Sky 1st Chapter on Steam"></head><body><div class="apphub_AppName">Trails in the Sky 1st Chapter</div><div class="page"><div class="hero"></div><aside class="rightcol"></aside></div></body></html>`,
  }));
