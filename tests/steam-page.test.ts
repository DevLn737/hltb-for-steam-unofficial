...
describe('Steam page detection', () => {
  it('prefers the visible Steam title over URL slug and metadata', () => {
    ...
    expect(extractSteamGamePage(document, 'https://store.steampowered.com/app/3375780/Wrong_Slug/')).toEqual({
      ...
      artworkUrl: 'https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/3375780/library_600x900_2x.jpg',
      backdropUrl: 'https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3375780/header.jpg',
    });
  ...
  it('falls back to the decoded URL slug', () => {
    expect(extractSteamGamePage(document, 'https://store.steampowered.com/app/10/HalfLife/')).toEqual({
      appId: '10', title: 'HalfLife',
      artworkUrl: 'https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/10/library_600x900_2x.jpg',
      backdropUrl: null,
    });
  });
